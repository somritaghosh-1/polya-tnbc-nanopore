...
| **Integrin stabilisation** | All detected integrins display above-average polyA tails |
...
**Integrin mRNA stabilisation:** All detected integrin subunits (ITGB1, ITGA1, ITGA2, ITGA3, ITGAV, ITGB5) display above-average polyA tail lengths, consistent with post-transcriptional mRNA stabilisation driving constitutive integrin expression and MDA-231 invasiveness. ITGB1 (mean 143.0 nt, n = 20,214 reads) is the most stably expressed gene in the dataset.
...
*Mean polyA tail length for all detected integrin subunits with 100 or more reads. Gradient blue bars indicate relative tail length intensity. All integrins exceed the dataset mean (red dashed line). Values show mean tail length and excess above dataset mean. Error bars = 95% CI.*
...
The integrin family (ITGB1 at 143.0 nt, ITGA1 at 134.7 nt, ITGA2 at 134.7 nt, ITGA3 at 122.0 nt, ITGAV at 167.2 nt, and ITGB5 at 106.6 nt) all exceed the dataset mean. Integrins are the primary mediators of MDA-231 adhesion and invasion through extracellular matrix interactions. Constitutive post-transcriptional stabilisation of integrin transcripts adds a new regulatory dimension to understanding MDA-231 invasiveness.
